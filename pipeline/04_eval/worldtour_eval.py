...
results_worldtour/<cid>.json. Usage: python lastdance_eval.py <gpu> <cids_csv>
"""
...
ADAP = "adapters_worldtour"; OUTD = "results_worldtour"; os.makedirs(OUTD, exist_ok=True)
...
for cid in CIDS:
    ...
    ocean = {c: round(table["BFI-2"][c][0],2) for c in CODES}
