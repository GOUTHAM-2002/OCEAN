...
results_worldtour_ffpi/<cid>.json. Usage: python lastdance_eval.py <gpu> <cids_csv>
"""
...
ADAP = "adapters_worldtour"; OUTD = "results_worldtour_ffpi"; os.makedirs(OUTD, exist_ok=True)
N_SEEDS = 4; BATCH = 12; TCI = 3.182  # big batch, 1 shot -> few gen calls (fast)
CODES = ["O", "C", "E", "A", "N"]
ACC = ("1 = Very Inaccurate\n2 = Moderately Inaccurate\n3 = Neither Accurate Nor Inaccurate\n"
       "4 = Moderately Accurate\n5 = Very Accurate")
AGREE = ("1 = Disagree strongly\n2 = Disagree a little\n3 = Neutral; no opinion\n"
         "4 = Agree a little\n5 = Agree strongly")
CONFIGS = [dict(q="ffpi_questions.csv", title="FFPI",
...
def eval_instrument(model, title):
    ...
    while len(runs) < N_SEEDS and seed < 2:
...
for cid in CIDS:
    ...
    ocean = {c: round(table["FFPI"][c][0],2) for c in CODES}
