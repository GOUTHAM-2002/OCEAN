...
WizardLM-13B-V1.2 DPO adapters.
...
results_WizardLM-13B-V1.2_*.json (same loader as radar_user_100.py).
...
g_plots/WizardLM/WizardLM-13B-V1.2/downstream/.
"""
import os, json, glob
import numpy as np
...
DSROOT = os.path.join(HERE, "results_downstream_wiz7b")
...
report = []
report.append(f"wizardLM-7B downstream OCEAN-shift regressions")
...
fig.suptitle("wizardLM-7B: downstream score shift ~ OCEAN shift (pooled, 95% CI; red=p<.05)", y=1.03)
