...
report = []
report.append(f"WizardLM-13B-V1.2 downstream OCEAN-shift regressions")
...
fig.suptitle("WizardLM-13B-V1.2: downstream score shift ~ OCEAN shift (pooled, 95% CI; red=p<.05)", y=1.03)
