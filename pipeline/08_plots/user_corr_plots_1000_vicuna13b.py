...
Outputs (one figure per beta, 5 trait subplots each, up to 1000 points each):
  g_plots/Vicuna/vicuna-13b-v1.5/USERS_1000_CORR/users1000_beta<b>_corr.png
...
OUTD = os.path.join(HERE, "g_plots", "Vicuna", SHORT, "USERS_1000_CORR")
TESTS = ["BFI-2", "FFPI"]
CODES = ["O", "C", "E", "A", "N"]
...
def user_ids():
    return json.load(open(os.path.join(HERE, "user_ids_1000_vicuna13b.json")))
